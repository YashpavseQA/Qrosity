...
export const useFetchProducts = (params: ProductQueryParams = {}) => {
  ...
  return useQuery<ProductListResponse>({
    ...
    queryFn: async () => {
      ...
      const url = `${apiEndpoints.products.list()}?${queryParams.toString()}`;
...
export const useFetchProduct = (productId: number | null) => {
  return useQuery<ProductDetail>({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(apiEndpoints.products.detail(productId));
      return response.data;
    },
    enabled: !!productId,
  });
...
export const useFetchProductVariants = (productId: number | null, params: { search?: string } = {}) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const url = `${apiEndpoints.products.variants.list(productId)}${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
      const response = await api.get(url);
      return response.data;
    },
    enabled: !!productId,
...
export const useFetchProductVariant = (productId: number | null, variantId: number | null) => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(apiEndpoints.products.variants.detail(productId, variantId));
      return response.data;
    },
  ...
  return useMutation({
    mutationFn: async (productData: ProductFormData) => {
      ...
      try {
        ...
        const response = await api.post(apiEndpoints.products.list(), productData);
  ...
  return useMutation({
    mutationFn: async (productData: ProductFormData) => {
      ...
      try {
        ...
        const response = await api.put(apiEndpoints.products.detail(productId), productData);
...
export const useDeleteProduct = () => {
  ...
  return useMutation({
    mutationFn: async (productId: number) => {
      ...
      await api.delete(apiEndpoints.products.detail(productId));
      return productId;
    },
    onSuccess: () => {
      // Invalidate products list query to refetch the data
      queryClient.invalidateQueries({ queryKey: ['products'] });
    },
  });
};
...
export const useCreateProductVariant = (productId: number) => {
  ...
  return useMutation({
    mutationFn: async (variantData: ProductVariantFormData) => {
      ...
      const response = await api.post(apiEndpoints.products.variants.list(productId), variantData);
      console.groupEnd();
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateProductVariant = (productId: number, variantId: number) => {
  ...
  return useMutation({
    mutationFn: async (variantData: ProductVariantFormData) => {
      ...
      const response = await api.put(apiEndpoints.products.variants.detail(productId, variantId), variantData);
      console.groupEnd();
      return response.data;
    },
    onSuccess: () => {
...
export const useDeleteProductVariant = (productId: number) => {
  ...
  return useMutation({
    mutationFn: async (variantId: number) => {
      await api.delete(apiEndpoints.products.variants.detail(productId, variantId));
      return variantId;
    },
    onSuccess: () => {
      // Invalidate variants list query to refetch the data
...
export const useFetchKitComponents = (productId: number | null) => {
  return useQuery({
    ...
    queryFn: async () => {
      if (!productId) throw new Error('Product ID is required');
      const response = await api.get(`${apiEndpoints.products.kitComponents.list(productId)}`);
      return response.data;
    },
    enabled: !!productId,
  });
...
export const useCreateKitComponent = (productId: number) => {
  ...
  return useMutation({
    mutationFn: async (componentData: any) => {
      const response = await api.post(`${apiEndpoints.products.kitComponents.list(productId)}`, componentData);
      return response.data;
    },
    onSuccess: () => {
...
export const useUpdateKitComponent = (productId: number, componentId: number) => {
  ...
  return useMutation({
    mutationFn: async (componentData: any) => {
      const response = await api.put(`${apiEndpoints.products.kitComponents.detail(productId, componentId)}`, componentData);
      return response.data;
    },
    onSuccess: () => {
      // Invalidate kit components list query to refetch the data
...
export const useDeleteKitComponent = (productId: number) => {
  ...
  return useMutation({
    mutationFn: async (componentId: number) => {
      await api.delete(`${apiEndpoints.products.kitComponents.detail(productId, componentId)}`);
      return componentId;
    },
    onSuccess: () => {
      // Invalidate kit components list query to refetch the data
...
export const useUpdateProductImage = ({ 
  ...
  return useMutation({
    mutationFn: async (imageData: {
      ...
      const response = await api.put(endpoint, imageData);
      return response.data;
    },
    onSuccess: () => {
