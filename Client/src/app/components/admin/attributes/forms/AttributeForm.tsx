        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth error={!!errors.data_type}>
              <InputLabel id="data-type-label">{t("Data Type")}</InputLabel>
              <Controller
                name="data_type"
                control={control}
                render={({ field }) => (
                  ...
                  >
                    <MenuItem value={AttributeDataType.TEXT}>
                      {t("attributes.attribute.dataTypes.text")}
                    </MenuItem>
                    <MenuItem value={AttributeDataType.NUMBER}>
                      {t("attributes.attribute.dataTypes.number")}
                    </MenuItem>
                    <MenuItem value={AttributeDataType.BOOLEAN}>
                      {t("attributes.attribute.dataTypes.boolean")}
                    </MenuItem>
                    <MenuItem value={AttributeDataType.DATE}>
                      {t("attributes.attribute.dataTypes.date")}
                    </MenuItem>
                    <MenuItem value={AttributeDataType.SELECT}>
                      {t("attributes.attribute.dataTypes.select")}
                    </MenuItem>
                    <MenuItem value={AttributeDataType.MULTI_SELECT}>
                      {t("attributes.attribute.dataTypes.multiSelect")}
                    </MenuItem>
                  </Select>
                )}
              />
