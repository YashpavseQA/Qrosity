...
export default function SideNav({ isOpen, onClose, variant, collapsedWidth, isRTL = false }: SideNavProps) {
  ...
  const mastersItems: NavItem[] = [
    ...
    { title: 'Products', path: '/Masters/products', icon: <ShoppingBasketOutlined />, translationKey: 'products' },
    { title: 'Unit of Measurement', path: '/Masters/catalogue/units-of-measure', icon: <StraightenOutlined />, translationKey: 'unitOfMeasures' },
    { title: 'Product Statuses', path: '/Masters/catalogue/product-statuses', icon: <StyleOutlined />, translationKey: 'productStatuses' },
    ...
    { title: 'Countries', path: '/Masters/countries', icon: <PublicOutlined />, translationKey: 'countries' },
    { title: 'Currencies', path: '/Masters/currencies', icon: <AttachMoneyOutlined />, translationKey: 'currencies' },
  ];
