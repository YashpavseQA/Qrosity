...
// Extended type to handle audit fields that might be present in the API response but not in the type definition
...
export default function CustomerGroupsPage() {
  ...
  const processedRows = useMemo(() => {
    ...
    return sortedData.map((group: CustomerGroupExtended) => ({
      ...group,
