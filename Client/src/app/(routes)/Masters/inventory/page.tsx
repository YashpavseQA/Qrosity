  ...
  return (
    <Box sx={{ 
      ...
      <AnimatedDrawer
        ...
        onSave={handleAdjustmentSubmit(onAdjustmentSubmit)}
        saveDisabled={isSubmittingAdjustment || isAdjustmentSubmitting}
        initialWidth={550}
        expandedWidth={800}
      >
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <FormControl fullWidth error={!!error}>
                      ...
                      <Select
                        ...
                        onChange={(e) => {
                          field.onChange(e);
                          const selectedLocation = locationsState.find(l => l.id === e.target.value);
                          if (selectedLocation) {
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ p: 2, bgcolor: 'background.paper', borderRadius: 1, border: '1px solid', borderColor: 'divider' }}>
                    ...
                    <Typography variant="h6">
                      {currentStock.availableQuantity || 0}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={12} md={6}>
                  <Box sx={{ p: 2, bgcolor: 'background.paper', borderRadius: 1, border: '1px solid', borderColor: 'divider' }}>
                    ...
                    <Typography variant="h6">
                      {currentStock.reservedQuantity || 0}
                    </Typography>
                  </Box>
                </Grid>
                <Grid item xs={12} md={6}>
              ...
              render={({ field, fieldState: { error } }) => (
                <FormControl fullWidth error={!!error}>
                  <TextField
                    ...
                    error={!!error}
                    helperText={error?.message}
                    placeholder="Add any additional notes or details about this adjustment"
                  />
                </FormControl>
              )}
            />
