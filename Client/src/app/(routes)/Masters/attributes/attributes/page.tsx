...
function AttributesPage() {
  ...
  //   return processed;
  // }, [data]);
  // In src/app/(routes)/Masters/attributes/attributes/page.tsx
const processedRows = useMemo(() => {
  console.log('API Response:+++++++++++++++++++++++', data);
  ...
  const renderDataTypeLabel = (dataType: AttributeDataType) => {
    switch (dataType) {
      case AttributeDataType.TEXT:
        return t('attributes.attribute.dataTypes.text');
      case AttributeDataType.NUMBER:
        return t('attributes.attribute.dataTypes.number');
      case AttributeDataType.BOOLEAN:
        return t('attributes.attribute.dataTypes.boolean');
      case AttributeDataType.DATE:
        return t('attributes.attribute.dataTypes.date');
      case AttributeDataType.SELECT:
        return t('attributes.attribute.dataTypes.select');
      case AttributeDataType.MULTI_SELECT:
        return t('attributes.attribute.dataTypes.multiSelect');
      default:
        return dataType;
    }
  };
